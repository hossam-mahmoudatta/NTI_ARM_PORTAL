...
#define CAN1_REG               ((volatile CAN_TypeDef*) CAN1_BASE)
#define CAN2_REG                ((volatile CAN_TypeDef*) CAN2_BASE)
...
#define  CAN_TSR_ABRQ0                       ((v)0x00000080)        /*!< Abort Request for Mailbox0 */
